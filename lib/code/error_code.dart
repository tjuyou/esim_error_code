...
const specMap = [
  ...
  ('8.1.1', '2.2', '1.Indicates that the EID is missing in the context of this order \n2.SM-DS address provided or MatchingID value has zero-length.'),
  ('8.1.1', '3.9', 'Indicates that the eUICC, identified by this EID is unknown to the SM-DP+.'),
  ('8.1.1', '3.10', '1.Indicates that a different EID is already associated with this ICCID. \n2.Indicates that the RPM Package is associated with different EID'),
  ...
  ('8.2.1', '3.3', '1.Indicates that the Profile identified by the provided ICCID is not available. \n2.The profile, identified by this ICCID, is already downloaded.'),
  ('8.2.1', '3.5', 'Indicates that the target Profile cannot be released.'),
  ('8.2.1', '3.9', '1.Indicates that the Profile, identified by this ICCID is unknown to the SM-DP+. \n2.Indicates that the installed Profile, identified by this ICCID, is unknown to the Service Provider.'),
  ...
  ('8.8.5', '6.4', '1.Maximum number of attempts of Profile Download has been exceeded \n2.Maximum number of retries for Profile download order exceeded'),
  ...
  ('8.10.1', '3.9', '1.Unknown Transaction ID in JSON transport layer after Authenticate Client or GetBoundProfilePackage \n2.Unknown Transaction ID in ASN.1 euiccSigned1 payload \n3.Unknown Transaction ID in ASN.1 CancelSessionResponse Element after Authenticate Client or GetBoundProfilePackage'),
  ('8.2.6', '3.8', '1.Invalid Matching ID for Profile Download Default DP+ Address Use Case \n2.Invalid Matching ID for Profile Download Activation Code Use Case \n3.Invalid Matching ID for Profile Download SM-DS Use Case \n4.Invalid MatchingId for Activation Code Use Case not associated to EID'),
  ('8.1.1', '3.8', '1.Un-matched EID for Default SM-DP+ Address Use Case \n2.Un-matched EID for SM-DS Use Case \n3.Un-matched EID for Activation Code Use Case'),
  ...
  ('8.1', '6.1', '1.Invalid eUICC Signature after Authenticate Client or GetBoundProfilePackage 2.Invalid Server Challenge'),
  ('8.8', '3.10', 'Invalid OID after Authenticate Client or GetBoundProfilePackage'),
  ('8.9.5', '3.3', '1.Event Record Already Exists without Event Forwarding \n2.Event Record Already Exists on Alternative SM-DS'),
  ('8.9', '5.1', '1.SM-DS registration failed, Root SM-DS unavailable \n2.Cascaded Event Deletion failed, Root SM-DS Unavailable'),
  ('8.9', '4.2', '1.SM-DS registration failed, Root SM-DS error \n2.Cascaded Event Deletion failed, Root SM-DS execution error'),
  ('8.9.5', '3.9', '1.Event Record Does Not Exist \n2.Event Record Does Not Match OID'),
];
